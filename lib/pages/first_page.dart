          ...
          AspectRatio(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Piece? piece = game.getPiece(Coord(row, column));
            ...
            child: Row(
              ...
              children: <Widget>[
                IconButton(
                    ...
                    onPressed: () {}),
                IconButton(
                    icon: const Icon(Icons.keyboard_arrow_left), iconSize: 36, tooltip: 'previous', onPressed: () {}),
                IconButton(
                    icon: const Icon(Icons.keyboard_arrow_right), iconSize: 36, tooltip: 'next', onPressed: () {}),
                IconButton(
